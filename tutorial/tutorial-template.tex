...
You should have gotten a uid and password. 
...
% \end{lstlisting}
And then do a\\
\cmd{ssh secure\_tutorial} \\
You may probably need to choose your favorite shell, e.g. type: \\
\cmd{bash} \\
and you will be in a Bash-Shell. \\
You should now be in your \texttt{\$HOME} and you can enter our \texttt{job\_template} directory. 
...
\textbf{Insert ssh public key uploading in LDAP here?}
...
\tutorial{Enrypting your Batch Script}{10}
